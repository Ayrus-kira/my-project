    ...
    return <div className={footerCss.footer}>
        <div className={footerCss.innerFooter}>
            <div className={footerCss.sec1}>
                <div className={footerCss.logoBox}>DiwaliHub</div>
            ...
            <div className={footerCss.sec2}>
                ...
                <div className={[footerCss.box2, footerCss.box].join(' ')}>
                    ...
                    <a href="" className={footerCss.boxOpt}>DiwaliHub</a>
                ...
                <div className={[footerCss.box3, footerCss.box].join(' ')}>
                    ...
                    <a href="" className={footerCss.boxOpt}>DiwaliHub For Work</a>
                </div>
            ...
            <div className={footerCss.sec3}>
                By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy and Content Policies. All trademarks are properties of their respective owners. 2008-2022 © DiwaliHub™ Ltd. All rights reserved.
            </div>
        </div>
    </div>
}
